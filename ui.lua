...
--[[
    Unified UI Library
    Modernized with consistent design patterns
    Uses single Minecraftia font throughout
]]
...
local Library do
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self)
            ...
            InputMovementConn = Library:Connect(UserInputService.InputChanged, LPH_NO_VIRTUALIZE(function(Input)
    ...
    -- Unified Font System (Minecraftia)
    local function InitializeFont()
        if isfile(Library.Folders.Assets .. "/main.ttf") then 
            pcall(function() delfile(Library.Folders.Assets .. "/main.ttf") end)
        end
        
        pcall(function()
            writefile(Library.Folders.Assets .. "/main.ttf", game:HttpGet("https://github.com/f1nobe7650/Nebula/raw/refs/heads/main/Minecraftia-Regular.ttf"))
        end)
            ...
            faces = {
                {
                    ...
                    weight = 400,
                    style = "normal",
                    assetId = getcustomasset(Library.Folders.Assets .. "/main.ttf")
                }
            }
        }
        
        if not isfile(Library.Folders.Assets .. "/main_encoded.ttf") then 
            writefile(Library.Folders.Assets .. "/main_encoded.ttf", HttpService:JSONEncode(minecraftia))
        end 
        
        Library.Font = Font.new(getcustomasset(Library.Folders.Assets .. "/main_encoded.ttf"), Enum.FontWeight.Regular)
        return Library.Font
    end

    Library.Font = InitializeFont()
    ...
    Library.DisconnectAll = function(self)
        for Index = #self.Connections, 1, -1 do
            local Connection = self.Connections[Index]
            if Connection and Connection.Connection and typeof(Connection.Connection.Disconnect) == "function" then
    ...
    local Components = { } do
            ...
            local Items = { } do
                ...
                if Data.SubPages then
                    Items["SubPages"] = Instances:Create("Frame", {
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(14, 14, 14)
                    })  Items["SubPages"]:AddToTheme({BackgroundColor3 = "Element", BorderColor3 = "Outline"})

                    -- Divider line under subtabs
        ...
        Components.WindowSubPage = function(self, Data)
            ...
            local Items = { } do
                ...
                })  Items["Inactive"]:AddToTheme({BackgroundColor3 = "Element", BorderColor3 = "Border"})
            ...
            function SubPage:Turn(Bool)
                ...
                if SubPage.Active then
                        ...
                        Items["Inactive"]:ChangeItemTheme({BackgroundColor3 = "Element"})
                        Items["Inactive"]:Tween(nil, {BackgroundTransparency = 1})
                        Items["Text"]:Tween(nil, {TextColor3 = FromRGB(178, 178, 178)})
                end
        ...
        Components.Toggle = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["ToggleOutline"] = Instances:Create("Frame", {
                ...
                Items["ToggleShading"] = Instances:Create("Frame", {
                    Parent = Items["ToggleOutline"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, 1, 0, 1),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, -2, 1, -2),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(92, 92, 92)
                })

                Items["ToggleInline"] = Instances:Create("Frame", {
                    Parent = Items["ToggleShading"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, 1, 0, 1),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, -2, 1, -2),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(54, 54, 54)
                })  Items["ToggleInline"]:AddToTheme({BackgroundColor3 = "Element"})
            ...
            function Toggle:Set(Value)
                ...
                if Toggle.Value then
                    ...
                    Items["Text"]:Tween(nil, {TextColor3 = FromRGB(255, 255, 255)})
                    Items["ToggleOutline"]:Tween(nil, {BackgroundTransparency = 0})
                    Items["ToggleShading"]:Tween(nil, {BackgroundTransparency = 0})
                    Items["ToggleInline"]:Tween(nil, {BackgroundColor3 = FromRGB(255, 255, 255)})
                    task.wait(0.05)
                    Items["Check"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {ImageTransparency = 0})
                else
                    Items["Text"]:ChangeItemTheme({TextColor3 = "Text"})
                    Items["Text"]:Tween(nil, {TextColor3 = FromRGB(178, 178, 178)})
                    Items["ToggleOutline"]:Tween(nil, {BackgroundTransparency = 1})
                    Items["ToggleShading"]:Tween(nil, {BackgroundTransparency = 1})
                    Items["ToggleInline"]:Tween(nil, {BackgroundColor3 = FromRGB(74, 74, 74)})
                    task.wait(0.05)
                    Items["Check"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {ImageTransparency = 1})
                end
        ...
        Components.Slider = function(self, Data)
            ...
            -- Store the connection reference to allow cleanup
            InputMovementConn = Library:Connect(UserInputService.InputChanged, LPH_NO_VIRTUALIZE(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
            ...
            -- Add a cleanup method to the slider
            function Slider:Destroy()
                if InputMovementConn then
                    Library:Disconnect(InputMovementConn.Name)
                    InputMovementConn = nil
                end
                if InputChanged then
                    InputChanged:Disconnect()
                    InputChanged = nil
        ...
        Components.Colorpicker = function(self, Data) -- poetry warning (╯°□°)╯
            ...
            Colorpicker.SlidePalette = LPH_NO_VIRTUALIZE(function(self, Input)
                ...
                -- Throttle callback to every 2 frames (~30ms at 60fps)
                local now = tick()
                if now - LastPaletteUpdate > 0.03 then
            ...
            Colorpicker.SlideHue = LPH_NO_VIRTUALIZE(function(self, Input)
                ...
                -- Throttle callback to every 2 frames (~30ms at 60fps)
                local now = tick()
                if now - LastHueUpdate > 0.03 then
                    Colorpicker:Update(false, true)
                    LastHueUpdate = now
                end
            end)
            ...
            Colorpicker.SlideAlpha = LPH_NO_VIRTUALIZE(function(self, Input)
                ...
                -- Throttle callback to every 2 frames (~30ms at 60fps)
                local now = tick()
                if now - LastAlphaUpdate > 0.03 then
                    Colorpicker:Update(true, true)
                    LastAlphaUpdate = now
                end
            end)
            ...
            local ColorpickerInputBeganConn = Library:Connect(UserInputService.InputBegan, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            -- Add cleanup method
            local OriginalColorpickerSetOpen = Colorpicker.SetOpen
            function Colorpicker:SetOpen(Bool)
                OriginalColorpickerSetOpen(self, Bool)
            end

            function Colorpicker:Destroy()
                if ColorpickerInputBeganConn then
                    Library:Disconnect(ColorpickerInputBeganConn.Name)
                    ColorpickerInputBeganConn = nil
                end
            end
        ...
        Components.Keybind = function(self, Data)
            ...
            local KeybindInputBeganConn = Library:Connect(UserInputService.InputBegan, function(Input)
            ...
            local KeybindInputEndedConn = Library:Connect(UserInputService.InputEnded, function(Input)
                if Keybind.Value == "None" then
                    return
                end
            ...
            -- Add cleanup method
            local OriginalKeybindSetOpen = Keybind.SetOpen
            function Keybind:Destroy()
                if KeybindInputBeganConn then
                    Library:Disconnect(KeybindInputBeganConn.Name)
                    KeybindInputBeganConn = nil
                end
                if KeybindInputEndedConn then
                    Library:Disconnect(KeybindInputEndedConn.Name)
                    KeybindInputEndedConn = nil
                end
            end
    ...
    Library.Pages.Section = function(self, Data)
        ...
        local Items = { } do
            ...
            -- Outer frame with layered shadows for depth
            ...
            Items["Shadow1"] = Instances:Create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundTransparency = 1,
                BackgroundColor3 = FromRGB(8, 8, 8)
            })

            -- Shadow layer 2 (inner)
            Items["Shadow2"] = Instances:Create("Frame", {
                Parent = Items["Shadow1"].Instance,
                Name = "\0",
                Position = UDim2New(0, 1, 0, 1),
                Size = UDim2New(1, -2, 1, -2),
                BorderColor3 = FromRGB(0, 0, 0),
            ...
            Items["Inner"] = Instances:Create("Frame", {
                ...
                BackgroundTransparency = 1,
                BackgroundColor3 = FromRGB(14, 14, 14)
            })  Items["Inner"]:AddToTheme({BackgroundColor3 = "Element"})

            -- Corner radius for all layers
